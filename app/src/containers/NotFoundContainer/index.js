...
class NotFound extends Component { // eslint-disable-line react/prefer-stateless-function
  ...
  renderContent() {
    ...
    const content = [
      ...
      {
        title: 'This corner of the App is still empty',
      ...
      {
        title: 'Fill this space with your ideas',
    ...
    return (
      <Section align="center">
        <Header className="introduction" justify="center" direction="column">
          ...
          <Paragraph alignContent="center">
            You've come to uncharted territory. 404-Land. - What? Right were you belong, you say? Then get ready to map!
          </Paragraph>
        </Header>
